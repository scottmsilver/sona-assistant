...
function peg$parse(input, options) {
  ...
  var peg$FAILED = {},
      ...
      peg$startRuleFunctions = { Intents: peg$parseIntents },
      peg$startRuleFunction  = peg$parseIntents,
      ...
      peg$c7 = function(intentName, all) {
      ...
      peg$c8 = peg$otherExpectation("intent-name"),
      peg$c9 = /^[a-zA-Z0-9]/,
      peg$c10 = peg$classExpectation([["a", "z"], ["A", "Z"], ["0", "9"]], false, false),
      peg$c11 = function() {
          return text();
        },
      peg$c12 = peg$otherExpectation("utterance-text"),
      peg$c13 = /^[a-zA-Z \-'\t]/,
  ...
  function peg$parseIntent() {
    ...
    if (s1 !== peg$FAILED) {
      ...
      if (s2 !== peg$FAILED) {
        s3 = [];
        s4 = peg$parseUtteranceText();
        if (s4 === peg$FAILED) {
          s4 = peg$parseUtteranceParameter();
        }
        if (s4 !== peg$FAILED) {
          while (s4 !== peg$FAILED) {
            s3.push(s4);
  ...
  function peg$parseUtteranceText() {
    var s0, s1, s2;
  ...
  function peg$parseUtteranceParameter() {
    var s0, s1, s2, s3;
